...
**APPROVED by Rob on 2026-09-07** ("approved. please continue with the next sprint"). Gate 1 scope is frozen; Docs/METRICS.md carries the FROZEN header. Gate 2 (Blockout Props & Composition) starts from this build.
