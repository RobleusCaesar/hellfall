...
| Generated output | `Content/Maps/L_ExecutiveFloor.umap`, `Content/Maps/L_FeelGym.umap`, `Content/Greybox/Materials/M_GB_*.uasset` (29 tints, 11 of them textured) | Output only (Git LFS), never hand-edited. **Regenerated 2026-09-06 for gate-1:** `L_ExecutiveFloor` = the 37-room law-firm floor, **590 actors** (129 walls, 41 headers, 37 floor + 37 ceiling slabs, 59 fill lights, 31 markers); `L_FeelGym` = the enclosed hall, **222 actors** (48 hall lights + 12 station lights). The floor's design lives in `Docs/candidates/legal_lead.build.mjs`, which writes `Data/candidates/legal_lead.json` = `Data/floorplan.json`; the gate-0 maps (249 / 171 actors, committed in `12faf06`, shipped in gate-0) are reproducible from `Data/candidates/floorplan_gate0.json`. Shipped in the gate-1 package (`Hellfall-gate-1-Win64-Development.zip`, `BUILD.md` 1.4). Re-committed at gate tags only. |
